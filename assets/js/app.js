...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const portfolioData = [
    ...
    },
    {
      ...
      description: "Animación de personaje interactuando con su entorno natural, aplicando simulación de físicas e iluminación global.",
      tools: ["Houdini FX", "Cinema 4D", "Redshift"],
    },
    {
      id: 10,
      title: "Animación 3D: Vida Submarina",
      category: "Animación 3D",
      instagramUrl: "https://www.instagram.com/lisarstudiooficial/",
      type: "video",
      videoFile: "https://res.cloudinary.com/demo/video/upload/sea_turtle.mp4",
      description: "Secuencia de acción animada en entorno 3D submarino. Trabajo avanzado de layout y causticas.",
    ...
    },
    {
      ...
      instagramUrl: "https://www.instagram.com/lisarstudiooficial/",
      type: "video",
      videoFile: "https://res.cloudinary.com/demo/video/upload/kitten_playing.mp4",
